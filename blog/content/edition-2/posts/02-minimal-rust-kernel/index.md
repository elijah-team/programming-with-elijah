...
Currently, we only provide BIOS support, but support for UEFI is planned, too. If you'd like to help us with this, check out the [Github issue](https://elijah-team.github.io/programming-with-elijah/issues/349).
...
(We don't provide UEFI support at the moment, but we would love to! If you'd like to help, please tell us in the [Github issue](https://elijah-team.github.io/programming-with-elijah/issues/349).)
